...
public class Plot3D
  ...
  boolean cmon = true;
  int cameraView = 0;
  double potE=0, kinE=0, totE=0;
  vector angMom = new vector();
  boolean countFrames = false;
  boolean enCalc = false;
  boolean amCalc = false;
  ...
  Scrollbar planetSize = new Scrollbar();
  ...
  TextField potentialE = new TextField();
  TextField kineticE = new TextField();
  TextField totalE = new TextField();
  TextField amx = new TextField();
  TextField amy = new TextField();
  ...
  Button energyCalc = new Button();
  Button angleMom = new Button();
  Button frameC = new Button();
  Button collIn = new Button();
  ...
  private void jbInit() throws Exception {
    ...
    collIn.addActionListener(this);
    collIn.setBounds(new Rectangle(12, 52, 118, 25));
    collIn.setLabel("Collision");
    collIn.setActionCommand("Collision");
    collIn.setForeground(Color.red);
    collIn.setBackground(Color.white);
    ...
    frameCount.setBounds(new Rectangle(520,82,150,25));
    frameCount.setBackground(new Color(192,255,255));
    
    potentialE.setColumns(10);
    potentialE.setBounds(new Rectangle(520,112,150,25));
    potentialE.setBackground(new Color(192,192,255));
    
    kineticE.setColumns(10);
    kineticE.setBounds(new Rectangle(680,112,150,25));
    kineticE.setBackground(new Color(192,192,255));
    
    totalE.setColumns(10);
    totalE.setBounds(new Rectangle(840,112,150,25));
    totalE.setBackground(new Color(192,192,255));
    
    amx.setColumns(10);
    amx.setBounds(new Rectangle(520,142,150,25));
    amx.setBackground(new Color(255,192,255));
    
    amy.setColumns(10);
    amy.setBounds(new Rectangle(680,142,150,25));
    amy.setBackground(new Color(255,192,255));
	
	amz.setColumns(10);
    amz.setBounds(new Rectangle(840,142,150,25));
    amz.setBackground(new Color(255,192,255));
		
    btnPrev.setActionCommand("prev");
    btnPrev.addActionListener(this);
    btnPrev.setLabel("<");
    btnPrev.setBounds(new Rectangle(12, 187, 58, 25));
    btnPrev.setBackground(Color.white);

    btnNext.setActionCommand("next");
    btnNext.addActionListener(this);
    btnNext.setLabel(">");
    btnNext.setBounds(new Rectangle(72, 187, 58, 25));
    btnNext.setBackground(Color.white);

    btnStart.addActionListener(this);
    btnStart.setBounds(new Rectangle(12, 217, 118, 25));
    ...
    btnPause.setBounds(new Rectangle(12, 247, 118, 25));
    btnPause.addActionListener(this);

    btnView.setBackground(Color.white);
    btnView.setLabel("Center");
    btnView.setBounds(new Rectangle(12, 277, 118, 25));
    ...
    cameraType.setBounds(new Rectangle(12,367,118,25));
    cameraType.addActionListener(this);
    
    lblSpeed.setText("Speed");
    lblSpeed.setBounds(new Rectangle(12, 405, 118, 18));
    ...
    scrollSpeed.setBounds(new Rectangle(12, 425, 118, 15));
    ...
    scrollTail.setBounds(new Rectangle(12, 445, 118, 15));

    planetSize.setBackground(Color.white);
    planetSize.setEnabled(true);
    planetSize.setMaximum(5000);
    planetSize.setMinimum(0);
    planetSize.setOrientation(0);
    planetSize.setUnitIncrement(10);
    planetSize.setValue(100);
    planetSize.setBounds(new Rectangle(12,465,118,15));
    ...
    tailLen.setValue(50);
    tailLen.setBounds(new Rectangle(12,475,118,15));
	*/

    setPx.setColumns(5);
    setPx.setBounds(new Rectangle(12, 505, 38, 20));
    setPx.setText("0");
    setPx.setBackground(new Color(255,255,192));
    
    setPy.setColumns(5);
    setPy.setBounds(new Rectangle(52, 505, 38, 20));
    setPy.setText("0");
	setPy.setBackground(new Color(255,255,192));

    setPz.setColumns(5);
    setPz.setBounds(new Rectangle(92,505,38,20));
    setPz.setText("30");
	setPz.setBackground(new Color(255,255,192));

    setRx.setColumns(5);
    setRx.setBounds(new Rectangle(12,530,58,20));
    setRx.setText("0");
	setRx.setBackground(new Color(255,255,192));

    setRy.setColumns(5);
    setRy.setBounds(new Rectangle(72,530,58,20));
    setRy.setText("0");
    setRy.setBackground(new Color(255,255,192));

    btnSnap.setActionCommand("Snap");
    btnSnap.setBackground(new Color(255,255,192));
    btnSnap.setLabel("Snap");
    btnSnap.setBounds(new Rectangle(12,555,118,25));
	...
	CenMass.setBounds(new Rectangle(12,585,118,25));
	CenMass.addActionListener(this);
	
	    stoptime.setColumns(5);
    stoptime.setBounds(new Rectangle(12,615,118,20));
    stoptime.setText("0");
	stoptime.setBackground(new Color(192,255,192));

    iterate.setActionCommand("iterate");
    iterate.setBackground(new Color(192,255,192));
    iterate.setLabel("Iterate");
    iterate.setBounds(new Rectangle(12,645,118,25));
    iterate.addActionListener(this);    

    tracker1.setColumns(5);
    tracker1.setBounds(new Rectangle(12,675,58,20));
    tracker1.setText("0");
    tracker1.setBackground(new Color(255,192,192));
    
    tracker2.setColumns(5);
    tracker2.setBounds(new Rectangle(72,675,58,20));
    tracker2.setText("0");
    tracker2.setBackground(new Color(255,192,192));
    
    trackerR.setColumns(10);
    trackerR.setBounds(new Rectangle(12,705,118,20));
    trackerR.setText("0");
    trackerR.setBackground(new Color(255,192,192));
    
    NetVel.setActionCommand("TogVel");
	NetVel.setBackground(new Color(255,192,192));
	NetVel.setLabel("DisTrack");
	NetVel.setBounds(new Rectangle(12,735,118,25));
	NetVel.addActionListener(this);
    
    frameC.setActionCommand("CF");
	frameC.setBackground(new Color(192,255,255));
	frameC.setLabel("Frame Counter");
	frameC.setBounds(new Rectangle(12,765,118,25));
	frameC.addActionListener(this);

    energyCalc.setActionCommand("EC");
    energyCalc.setBackground(new Color(192,192,255));
    energyCalc.setLabel("Energy");
    energyCalc.setBounds(new Rectangle(12,795,118,25));
    energyCalc.addActionListener(this);
    
    angleMom.setActionCommand("AM");
    angleMom.setBackground(new Color(255,192,255));
    angleMom.setLabel("Angular Momentum");
    angleMom.setBounds(new Rectangle(12,825,118,25));
    angleMom.addActionListener(this);
    
    this.add(canvas1, null);
    this.add(lblTitle, null);
    this.add(txtCoord, null);
    this.add(frameCount,null);
    this.add(totalE,null);
    this.add(potentialE,null);
    this.add(kineticE,null);
    this.add(amx,null);
    this.add(amy,null);
    this.add(amz,null);
...
//  this.add(tailLen, null);
    ...
    this.add(frameC,null);
    this.add(energyCalc,null);
    this.add(angleMom,null);
    this.add(collIn,null);
    ReadPlanets(1);
    Center();
    reStart();
  }
  ...
  void reStart() {
	...
	shadeOfRed=255;
	txtCoord.setBackground(new Color(255,shadeOfRed,shadeOfRed));
  ...
  public void paint(Graphics g) {
    ...
    if((cameraView==1)&&(nplanet==3)) //cross 3 calculations
	{
	...
	if(cameraView==2); //follow center calculations
	{
		if(pCenter!=-1)
		{
			double tempx = planet[pCenter].r.x;
			double tempy = planet[pCenter].r.y;
			double tempz = planet[pCenter].r.z;
			if(tempx!=0)
			{
				rotY = StrictMath.atan(tempz/tempx);
				rotY *= 180/StrictMath.PI;
				if(tempx<0) rotY+=180;
    ...
    if (pCenter >= 0){ //switch to center on appropriate camera
      mat.transform(planet[pCenter].r);
      if(cameraView!=2) dx -= planet[pCenter].r.tx;
      if(cameraView!=2) dy -= planet[pCenter].r.ty;
    }
    ...
    double somevalue = (double) planetSize.getValue();
    for (int i = 0; i < nplanet; i++) {
      double z = mat.transform(planet[i].r);
      buffer_g.setColor(colors[planet[i].id % 10]);
      int radius = (int) StrictMath.round(StrictMath.sqrt(planet[i].mass) * (somevalue/100.0) / z * 100.0);
	...
	//draw the center of mass (if requested)
	if(cmon==true)	{
		double nmass=0;
		...
		int radius = (int) StrictMath.round((somevalue/100.0) * (1 / mat.transform(cm) * 100));
...
//        rotX = -90;
  ...
  void UpdatePlanets() {
	...
	if(countFrames==true) frameCount.setText(tLong.toString());
	if(framenum%10==0)
	{	shadeOfRed++;
	...
	//artifact code that used to change the color of the snap button
	/*
	if (Planet.LEN == 500)
	...
	*/
	...
	//update the potential and kinetic energies
	if(enCalc==true)
	{
		...
		for (int i = 0; i < nplanet; i++)
		{
			kinE = kinE + (planet[i].mass * planet[i].v.mag() * planet[i].v.mag()/2);
			for(int j=i+1; j < nplanet; j++)
			{
					double d = planet[i].r.distance(planet[j].r);
					potE = potE + (planet[i].mass * planet[j].mass / d);
			}
			
		}
		Double temp = new Double(potE);
		potentialE.setText(temp.toString());
		temp = new Double(kinE);
		kineticE.setText(temp.toString());
		temp = new Double(kinE-potE);
		totalE.setText(temp.toString());
	}
	...
	if(amCalc==true)
	{
		...
		for(int i=0; i<nplanet; i++)
		{
			...
			v2.add(planet[i].v,1);
			tvec.cross(v1, v2);
			angMom.add(tvec,planet[i].mass);
		}
		Double temp = new Double(angMom.x);
		amx.setText(temp.toString());
		temp = new Double(angMom.y);
		amy.setText(temp.toString());
		temp = new Double(angMom.z);
		amz.setText(temp.toString());
...
//    Planet.LEN = tailLen.getValue();
  ...
  public void actionPerformed(ActionEvent e) {
    if (e.getActionCommand() == "pause") {
	  ...
	  if(disTrack == true)
	  {
	  	NetVel.setBackground(Color.black);
	  	NetVel.setForeground(new Color(255,192,192));
	  }
	  if(disTrack == false)
	  {
	  	 NetVel.setBackground(new Color(255,192,192));
	  	 NetVel.setForeground(Color.black);
	  }
	}
	else if (e.getActionCommand() == "CameraShift")
	{
		...
		if(cameraView==2) cameraType.setLabel("Follow Center");
	}
	else if(e.getActionCommand() == "EC")
	{
		enCalc = !enCalc;
		if(enCalc==true) 
		{
			energyCalc.setBackground(Color.black);
			energyCalc.setForeground(new Color(192,192,255));
		}
		if(enCalc==false)
		{
			energyCalc.setBackground(new Color(192,192,255));
	...
	else if(e.getActionCommand() == "AM")
	{
		amCalc = !amCalc;
		if(amCalc==true)
		{
			angleMom.setBackground(Color.black);
			angleMom.setForeground(new Color(255,192,255));
		}
		if(amCalc==false)
		{
			angleMom.setBackground(new Color(255,192,255));
			angleMom.setForeground(Color.black);
		}
		
	}
	else if(e.getActionCommand() == "CF")
	{
		countFrames = !countFrames;
		if(countFrames==true)
		{
			frameC.setBackground(Color.black);
			frameC.setForeground(new Color(192,255,255));
		}
		if(countFrames==false)
		{
			frameC.setBackground(new Color(192,255,255));
			frameC.setForeground(Color.black);
		}
	}
	else if(e.getActionCommand() == "Collision")
	{
		showCol = !showCol;
		if(showCol==true)
		{
		...
		if(showCol==false)
		{
			collIn.setForeground(Color.black);
		}
